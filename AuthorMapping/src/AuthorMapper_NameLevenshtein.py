...
from AuthorMapping.COLUMNS import Column, CHAR_DROPOUT_RATE
from AuthorMapping.src.AuthorMapper import AuthorMapper


class NameBLEUMapper(AuthorMapper):
    def __init__(self):
        super().__init__()
        # self.name_id_dict = {}
    ...
    def _run_mapping(self, sample: Column):
        ...
        for x in self.all_samples:
            ...
            score = Levenshtein.ratio(x.name, sample.name)
            # print(score)
